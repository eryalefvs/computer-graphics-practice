# Mude a função “on_mouse_press(x,y,button)” para mover o triângulo com 
# o botão direito (button == 2) e alterar a posição do vértice com botão 
# esquerdo (button == 1). 
...
def setup():
    update_triangle_position(-0.5, -0.5)
